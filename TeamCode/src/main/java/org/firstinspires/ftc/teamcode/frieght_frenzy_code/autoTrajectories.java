...
//some var has been changed (like -67 -> -69 in park poses)
    public Pose2d startPoseRC = new Pose2d(-31, -65.75);
    public Pose2d startPoseRW = new Pose2d(14, -67.75);
    public Pose2d startPoseBC = new Pose2d(-41, 67.75);
    public Pose2d startPoseBW = new Pose2d(4, -65.75);
    ...
    public Vector2d toParkBlueStorage = new Vector2d(60, 36);
}

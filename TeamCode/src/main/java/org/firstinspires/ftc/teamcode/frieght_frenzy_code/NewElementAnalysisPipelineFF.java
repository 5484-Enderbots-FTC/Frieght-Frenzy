...
public class NewElementAnalysisPipelineFF extends OpenCvPipeline {
    /*
    ...
    {
        public NewElementAnalysisPipelineFF.ObjectType object;
        double angle;
        public double rectWidth;
        public double rectHeight;
        double WidthHeightRatio;
        public NewElementAnalysisPipelineFF.Section section;
    ...
    ArrayList<NewElementAnalysisPipelineFF.AnalyzedElement> internalElementList = new ArrayList<>();
    volatile ArrayList<NewElementAnalysisPipelineFF.AnalyzedElement> clientElementList = new ArrayList<>();
    ...
    NewElementAnalysisPipelineFF.Stage[] stages = NewElementAnalysisPipelineFF.Stage.values();
    ...
    public ArrayList<NewElementAnalysisPipelineFF.AnalyzedElement> getDetectedElements()
    {
    ...
    void analyzeContour(MatOfPoint contour, Mat input)
    {
        ...
        //if (rotatedRectFitToContour.size.width > 60 && rotatedRectFitToContour.size.height > 30) {
            ...
            NewElementAnalysisPipelineFF.ContourRegionAnalysis aboveMidlineMetrics = analyzeContourRegion(aboveMidline);
            NewElementAnalysisPipelineFF.ContourRegionAnalysis belowMidlineMetrics = analyzeContourRegion(belowMidline);
            ...
            NewElementAnalysisPipelineFF.AnalyzedElement analyzedElement = new NewElementAnalysisPipelineFF.AnalyzedElement();
            ...
            analyzedElement.object = NewElementAnalysisPipelineFF.ObjectType.ALLIANCE_SHIPPING_ELEMENT;
            ...
            if (rotatedRectFitToContour.center.x <= DIVISION_ONE) {
                analyzedElement.section = NewElementAnalysisPipelineFF.Section.LEFT;
            } else if (rotatedRectFitToContour.center.x > DIVISION_ONE && rotatedRectFitToContour.center.x < DIVISION_TWO) {
                analyzedElement.section = NewElementAnalysisPipelineFF.Section.MID;
            } else if (rotatedRectFitToContour.center.x >= DIVISION_TWO) {
                analyzedElement.section = NewElementAnalysisPipelineFF.Section.RIGHT;
            }
    ...
    static NewElementAnalysisPipelineFF.ContourRegionAnalysis analyzeContourRegion(ArrayList<Point> contourPoints)
    {
        ...
        if(hullMatOfInt.toArray().length > 0)
        {
            ...
            NewElementAnalysisPipelineFF.ContourRegionAnalysis analysis = new NewElementAnalysisPipelineFF.ContourRegionAnalysis();

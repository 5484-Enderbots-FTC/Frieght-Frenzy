...
/***
 * THIS IS THE DRIVE WITH CANCELLABLE MOVEMENT NOT THE NORMAL ONE
 */
@Config
public class FFMecanumDriveCancelable extends MecanumDrive {
    /**
     * THIS GOT CHANGED BELOW SO IT MIGHT BREAK
     */
    ...
    public FFMecanumDriveCancelable(HardwareMap hardwareMap) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "mtrFL");
        leftFront.setDirection(DcMotorEx.Direction.REVERSE);
        leftRear = hardwareMap.get(DcMotorEx.class, "mtrBL");
        leftRear.setDirection(DcMotorEx.Direction.REVERSE);
        rightRear = hardwareMap.get(DcMotorEx.class, "mtrBR");
        rightRear.setDirection(DcMotorEx.Direction.FORWARD);
        rightFront = hardwareMap.get(DcMotorEx.class, "mtrFR");

...
public class autoTrajectories {
    ...
    public Pose2d blueCarouselReset = new Pose2d(-63, 57.5, Math.toRadians(180));
    ...
    public Vector2d blueHub3Flank = new Vector2d(-30, 20);
    public Vector2d blueHub2Flank = new Vector2d(-33.5, 20);
    public Vector2d blueHub1Flank = new Vector2d(-31.5, 20);
    ...
    public Pose2d toFlankBlue = new Pose2d(-50, 20, Math.toRadians(-90));
    ...
    public Vector2d toParkBlueStorageFlank = new Vector2d(-69 + 1, 33);
